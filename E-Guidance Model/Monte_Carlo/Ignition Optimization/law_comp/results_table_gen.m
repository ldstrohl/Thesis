...
input.tableCaption = 'Comparison of Performance of E-Guidance with APDG';
input.tableLabel = 'tab:EvsAPDG';
input.tablePlacement = 'ht';

load('rundata_simple.mat') % run results file
...
if latex_flag
    ...
    input.tableRowLabels = {'Runs','Fuel (kg)','Fuel $\sigma$','Fuel max','Fuel min','Flight Time (s)',...
