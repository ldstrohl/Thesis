...
%\usepackage[style=chicago-notes, autocite=inline,backend=biber]{biblatex}
\usepackage[style=chicago-notes, natbib=true, backend=biber]{biblatex}
...
% use customized bibliography file
%\bibliographystyle{acm_mod}

%\bibliographystyle{chicago-biblatex}
%\bibliography{thbib}

%% for chicago-biblatex
\printbibliography
