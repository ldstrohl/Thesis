...
maxnames=7,         % SDSU DTM guideline is up to 10
...
%\AtBeginBibliography{\renewcommand*{\mkbibnamefamily}[1]{\MakeUppercase{#1}}} % force author names
%\AtBeginBibliography{\renewcommand*{\mkbibnamegiven}[1]{\MakeUppercase{#1}}} % to be uppercase (DTM)
...
% add links compatible with adobe reader
...
\usepackage[left=1.25in, top=1in, right = 1in, bottom = 1in, headsep=18pt]{geometry} % set margins to meet your document's needs
%\usepackage{geometry}
...
\degreeONE{Master of Science}
\degreeTWO{in}
\degreeTHREE{Aerospace Engineering}
...
% insert bibliography and ensure new page
%\newpage
%\printbibliography
\newpage
\printbibliography
