...
% Produce SDSU-flavored CMS citations and bibliography using bastardized MLA style
\usepackage[
...
% include citation numbers in bibliography
\AtEveryBibitem{[\printfield{labelnumber}]\addspace\addspace}%Numbers in the bib
