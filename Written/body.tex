...
Figure\:\ref{fig:hfueldisppowatmo} again demonstrates the characteristic Gaussian distribution in propellant consumption, with fewer outlying low consumption runs in Case 1. Adapative PDI (Case 7) shows a lower mean than all other cases and maintains a similar distribution as the other cases. Range, speed, and failure histograms are given in the Appendix as they are qualitatively similar to the vacuum performance figures in Section\:\ref{sec:vacperf}.
