...
As is clear from Figures\:\ref{fig:trajunpowatmo_1} and\:\:\ref{fig:trajunpowatmo_2} by the placement of the initial conditions of the 6 cases, the initial conditions are chosen to represent the landing vehicle on aerodynamic approach making corrections toward the site. While employing the PDI strategy outlined in Section\:\ref{sec:ignitiontiming} the vehicle will travel along the atmospheric trajectory shown in Figures\:\ref{fig:trajunpowatmo_1} and\:\ref{fig:trajunpowatmo_2} until ignition.
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Trajectory: Simple vs. APDG Guidance Laws \label{fig:trajEvsADPG} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Altitude: Simple vs. APDG Guidance Laws \label{fig:altEvsADPG} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Ground Range: Simple vs. APDG Guidance Laws \label{fig:rngEvsADPG} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Speed: Simple vs. APDG Guidance Laws \label{fig:spdEvsADPG} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Thrust Magnitude: Simple vs. APDG Guidance Laws \label{fig:thrEvsADPG} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Angle of Attack: Simple vs. APDG Guidance Laws \label{fig:fatEvsADPG} }
	\end{minipage}
\end{figure}

Including dispersion results in similar profiles which will be examined more closely in later sections, but a numerical comparison of the laws' performance is given in Table\:\ref{tab:EvsADPG}. Each law was in control for 1000 runs. Results are presented as mean values and standard deviations $\sigma$. Both laws perform similarly with the APDG law showing slightly higher speed on approach and using more fuel. This inaccuracy will be addressed in Section\:\ref{sec:naverror}
...
Presented here are results for the Vacuum condition. 

Figures\:\ref{fig:trajpowvac} through\:\ref{fig:thrpowvac} show nominal results for all cases.
