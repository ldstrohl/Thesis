...
\begin{table}[ht]                                                                                              
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}                                                                         
		\hline                                                                                                         
		& Runs & Fuel & Fuel $\sigma$ & Flight Time & FT $\sigma$ & Range & Range $\sigma$ & Speed & Speed $\sigma$ \\
		\hline                                                                                                         
...
\begin{table}[ht]                                                                                              
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}                                                                         
		...
		\hline                                                                                                         
		Adv. E-Guidance & 1000 & 9849.8 & 287.3 & 95.0 & 2.0 & 2.5 & 1.9 & 8.0 & 3.6 \\                                
		\hline                                                                                                         
	\end{tabular}                                                                                                  
	\caption{Comparison of Performance of E-Guidance with Commanded Final Attitude E-Guidance}                     
	\label{table:tab:simvsadv}                                                                                     
\end{table}      

\subsection{Navigation Error}
Table and figures for the following condition:
Advanced Guidance Law
...
\begin{table}[ht]                                                                                              
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}                                                                         
		...
		& Runs & Fuel & Fuel $\sigma$ & Flight Time & FT $\sigma$ & Range & Range $\sigma$ & Speed & Speed $\sigma$ \\
		\hline                                                                                                         
		Nav Error & 1000 & 9849.8 & 287.3 & 95.0 & 2.0 & 2.5 & 1.9 & 8.0 & 3.6 \\                                      
		\hline                                                                                                         
		No Nav Error & 1000 & 9761.8 & 270.8 & 95.2 & 2.0 & 0.1 & 0.0 & 1.0 & 0.0 \\                                   
		\hline                                                                                                         
	\end{tabular}                                                                                                  
	\caption{Comparison of Performance With and Without Navigation Error}                                          
	\label{table:tab:navvsnonav}                                                                                   
\end{table}   
