...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Unpowered Initial Trajectory In Vacuum Ground Range \label{fig:trajunpowatmo_2} }
	\end{minipage}
\end{figure}

As is clear from Figures\:\ref{fig:trajunpowatmo_1} and\:\:\ref{fig:trajunpowatmo_2} by the placement of the initial conditions of the 6 cases, the initial conditions are chosen to represent the landing vehicle on aerodynamic approach making corrections toward the site. While employing the ignition timing strategy outlined in Section\:\ref{sec:ignitiontiming} the vehicle will travel along the atmospheric trajectory shown in Figures\:\ref{fig:trajunpowatmo_1} and\:\ref{fig:trajunpowatmo_2} until ignition.
...
\subsection{Comparison of E-Guidance with Advanced E-Guidance}
...
The choice between simple E-Guidance of Equation\:\ref{eqn:simplelaw} as flown on the Apollo missions and the advanced version with final attitude constraint of Equation\:\ref{eqn:advancedlaw} is examined below. Results are first presented as nominal performance in atmosphere in order to investigate the individual performance of each law without the distraction of dispersion. Beyond this section, results will be presented using the advanced law which will be referred to simply as the Guidance Law.

Figures\:\ref{fig:trajsimvsadv} through\:\ref{fig:fatsimvsadv} show plotted quantities of a rocket in atmosphere employing the ignition timing strategy on approach to landing at the origin from Initial Condition Case 6 (Table\:\ref{tab:IC}). In Figure\:\ref{fig:trajsimvsadv} the trajectory with the steeper approach upon landing is flown by the advanced guidance law. 

The laws each result in similar trajectories as evidenced by Figures\:\ref{fig:trajsimvsadv} through\:\ref{fig:fatsimvsadv}. However, the thrust and therefore speed profiles are notably different, with the Advanced law starting at a lower magnitude of thrust in Figure\:\ref{fig:thrsimvsadv} than the Simple law and their profiles roughly reversed. The Angle of Attack in Figure\:\ref{fig:fatsimvsadv} profiles are very different, with the Advanced law providing a final angle of attack much closer to $90^\circ$. Since the vehicle's velocity is vertical as specified by the terminal constraints, an angle of attack close to $90^\circ$ suggests a vertical descent.

\begin{figure}[H]
	\centering
	\begin{minipage}{4.5 in}
		\includegraphics[width=\linewidth]{Figures/trajsimvsadv.pdf}
		\caption{Trajectory: Simple vs. Advanced Guidance Laws \label{fig:trajsimvsadv} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Altitude: Simple vs. Advanced Guidance Laws \label{fig:altsimvsadv} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Ground Range: Simple vs. Advanced Guidance Laws \label{fig:rngsimvsadv} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Speed: Simple vs. Advanced Guidance Laws \label{fig:spdsimvsadv} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Thrust Magnitude: Simple vs. Advanced Guidance Laws \label{fig:thrsimvsadv} }
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{4.5 in}
		...
		\caption{Angle of Attack: Simple vs. Advanced Guidance Laws \label{fig:fatsimvsadv} }
	\end{minipage}
\end{figure}

Including dispersion results in similar profiles which will be examined more closely in later sections, but a numerical comparison of the laws' performance is given in Table\:\ref{tab:simvsadv}. Each law was in control for 1000 runs. Results are presented as mean values and standard deviations $\sigma$. Both laws perform similarly with the advanced law showing slightly higher speed on approach and using more fuel. This inaccuracy will be addressed in Section\:\ref{sec:naverror}

\begin{table}[ht]                                                                                              
	\centering        
	\caption{Comparison of Performance of E-Guidance with Commanded Final Attitude E-Guidance}                     
	\label{tab:simvsadv}                                                                                              
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}                                                                         
		...
		\hline                                                                                                         
		Simple  & 1000 & 9707.4 & 280.1 & 95.2 & 2.0 & 1.9 & 1.5 & 5.9 & 3.1 \\                                     
		\hline                                                                                                         
		Adv.  & 1000 & 9849.8 & 287.3 & 95.0 & 2.0 & 2.5 & 1.9 & 8.0 & 3.6 \\                                       
		\hline                                                                                                         
	\end{tabular}                                                                                                  
...
Atmospheric effects
Dynamic Ignition Case
Comparing Navigation Error from to dispersion

The final speeds shown in Table\:\ref{tab:simvsadv} are not very accurate given the terminal constraint magnitude of $1\:m/s$. This constraint is important since it determines how softly the vehicle will land. However, this final speed (and range) inaccuracy is due almost entirely to the navigation dispersion model outlined in Section\:\ref{sec:navmod}, as is clear from the results given in Table\:\ref{tab:navvsnonav}. Here the simulation was run with atmospheric effects, ignition timing, and full initial condition and rocket parameter dispersion. The cases differed in whether navigation dispersion was active. The Nominal runs clearly show very accurate satisfaction of the terminal constraints. A more realistic model would include much lower navigation error near the landing site due to the availability of more accurate measurements through radar systems and short range devices and would result in similarly low inaccuracies. These more sophisticated sensor models are not investigated here since they would not impact the focus of this thesis.
