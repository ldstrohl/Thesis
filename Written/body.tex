...
Here we talk about the thrust acceleration and range criterion for ignition. 

... where $h$ is altitude and $s_{GT}$ is the downrange distance traveled during a gravity turn maneuver.
