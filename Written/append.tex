...
\begin{table}[hbt]
	...
	\begin{minipage}{3.5in}
		...
		\begin{tabular}{|c||c|c|c|c||}    \hline
			State &	Case & $\hat{e}_N$  &  $\hat{e}_E$ & $\hat{e}_D$ \\ \hline \hline
			$\bm{r}_0$ & 5 & 10  & 15 & $\pi$ \\ \hline
			$\bm{V}_0$ & 5 & 20  & 15 & $2\pi$ \\ \hline
			$\bm{r}_0$ & 4 & 10  & 15 & $\pi$ \\ \hline
			$\bm{V}_0$ & 4 & 20  & 15 & $2\pi$ \\ \hline
			$\bm{r}_0$ & 3 & 10  & 15 & $\pi$ \\ \hline
			$\bm{V}_0$ & 3 & 20  & 15 & $2\pi$ \\ \hline
			$\bm{r}_0$ & 2 & 10  & 15 & $\pi$ \\ \hline
			$\bm{V}_0$ & 2 & 20  & 15 & $2\pi$ \\ \hline
			$\bm{r}_0$ & 1 & 10  & 15 & $\pi$ \\ \hline
			$\bm{V}_0$ & 1 & 20  & 15 & $2\pi$ \\ \hline
		\end{tabular}
	\end{minipage}
\end{table}
